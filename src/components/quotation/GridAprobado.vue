    ...
    <div class="row">
      <div class="table-responsive">
        <div class="d-flex flex-sm-row flex-column bg-secondary">
          <div class="mr-auto p-2">
            ...
            <b-button title="Descargar PDF" @click="pdfListQuotation" variant="danger" class="ml-2">
              ...
              <span v-if="itemsApproved.length > 0">({{ itemsApproved.length }})</span>
            </b-button>
        ...
        <kendo-datasource
          ...
          :schema-data="'data'"
          :transport-read="{ url: `${url}/quotations/approved`, beforeSend: readData }"
...
export default {
  ...
  computed: {
    ...mapGetters(["itemsGeneral", "itemsApproved"])
  },

  mounted() {
    let grid = this.$refs.gridApproved.kendoWidget()
    let ds = []
  ...
  methods: {
    reloadTable() {
      this.$refs.gridApproved.kendoWidget().dataSource.filter({})
    },
